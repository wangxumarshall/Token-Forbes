...
export default function Methodology() {
  return (
    <section id="methodology" className="border-t border-white/10 bg-[#0a0a0a] py-20 sm:py-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* The Deep Value */}
        <div className="mb-20">
          <h3 className="mb-8 border-b border-white/10 pb-4 font-serif text-xl font-bold text-white sm:text-2xl">The Deep Value of Token Forbes</h3>
        ...
        {/* The Data Engine */}
        <div className="mb-20">
          <h3 className="mb-8 border-b border-white/10 pb-4 font-serif text-xl font-bold text-white sm:text-2xl">The Data Engine: How We Calculate</h3>
          <p className="text-gray-400 mb-8 max-w-4xl leading-relaxed">
            Outputting individual and enterprise lists requires overcoming extreme data acquisition challenges. We now blend public GitHub contributor statistics, GitHub Search API discovery, self-reported proofs, partner data, strong proxy variables, and model-based estimation across four main paths:
          </p>
          <div className="grid md:grid-cols-3 gap-8">
            <div className="rounded-2xl border border-white/10 bg-[#111] p-6 sm:p-8">
            ...
            <div className="rounded-2xl border border-white/10 bg-[#111] p-6 sm:p-8">
              ...
              <p className="text-gray-400 text-sm leading-relaxed">
                <strong>Social Monetization:</strong> A verified certification system allowing users to input average monthly consumption. We issue "Token Billionaire" virtual badges and social share cards to incentivize global developers to join the leaderboard.
              </p>
            </div>
            <div className="rounded-2xl border border-white/10 bg-[#111] p-6 sm:p-8 md:col-span-3">
        ...
        {/* Data Sources */}
        <div>
          <h3 className="mb-8 border-b border-white/10 pb-4 font-serif text-xl font-bold text-white sm:text-2xl">Data Sources & Priority</h3>
          <div className="space-y-4">
            <div className="flex flex-col gap-4 rounded-xl border border-white/5 bg-[#111] p-5 sm:flex-row sm:items-start sm:p-6">
